...
const BoardModal = ({
  ...
  const actionNameSuccess = "updated";
                ...
                <div className="relative flex w-full items-center overflow-hidden bg-white px-4 pt-14 pb-8 shadow-2xl sm:px-6 sm:pt-8 md:p-6 lg:p-8">
                  ...
                  <div className="grid w-full grid-cols-1 items-start ">
                    <div className="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-9xl mx-auto">
                      <h2 className="text-2xl font-bold text-gray-900 sm:pr-12">{actionName} Board</h2>
                            ...
                            (formik) => (
                              <Form>
                                <div className="grid gap-5 md:grid-cols-1">
                                  ...
                                  <div>
                                    <label className="block text-sm font-medium mb-1" htmlFor="email">Can smoke <span className="text-rose-500">*</span></label>
                                    <Field name="can_smoke" type="text" className="form-input w-full" />
                                    <ErrorMessage name="name" component="div" className="text-xs mt-1 text-rose-500" />
                                  </div>
