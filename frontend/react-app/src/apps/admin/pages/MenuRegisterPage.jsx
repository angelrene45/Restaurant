        ...
        <>
            <div  style={{ height:'80%', width: '80%'}}>
                        ...
                        <div class="bg-white px-4 py-5 sm:p-6">
                            ...
                            <div class="grid grid-cols-6 gap-6 mt-3">
                                <div class="col-span-6 sm:col-span-3">
                                    <label for="first-name" class="block text-sm font-medium text-gray-700">Categorie name</label>
                                    <input type="text" name="first-name" id="first-name" autocomplete="given-name" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm" ref={categorieInputRef} />
                                </div>
                            </div>
                        </div>
                ...
                <form action="#" method="POST">
                    <div class="overflow-hidden shadow sm:rounded-md mt-5">
                        <div class="bg-white px-4 py-5 sm:p-6">
                            <div class="grid grid-cols-6 gap-6">
                                <div class="col-span-6 sm:col-span-3">
                                    <label for="first-name" class="block text-sm font-medium text-gray-700">ame</label>
