...
import { useCreateCategoryMutation } from '../../../../store/slices/categories';

const MySwal = withReactContent(Swal);

export const CategoryAddModal = ({ open, setOpen }) => {
              ...
              <Dialog.Panel className="flex w-full transform text-left text-base transition md:my-8 md:max-w-2xl md:px-4 lg:max-w-4xl">
                <div className="relative flex w-full items-center overflow-hidden bg-white px-4 pt-14 pb-8 shadow-2xl sm:px-6 sm:pt-8 md:p-6 lg:p-8">
                  ...
                  <div className="grid w-full grid-cols-1 items-start ">
                    <div className="">
                      <h2 className="text-2xl font-bold text-gray-900 sm:pr-12">Add Category</h2>
